...
class TestScooterHomePage:
    ...
    @pytest.mark.parametrize('question, answer, text_answer', [
        ...
        [ORDER_SCOOTER_TODAY, TEXT_ORDER_SCOOTER_TODAY,
    ...
    def test_open_questions_and_check_text(self, firefox_driver, question, answer, text_answer):
    ...
    def test_click_logo_yandex(self, firefox_driver):
        scooter_home_page = ScooterHomePage(firefox_driver)
